...
export const metadata = {
  title: 'Android Color Guidelines | exdreamcolors',
  description: 'Learn about android color guidelines. Complete guide with examples, best practices, and practical tips for web designers and developers.',
  keywords: ['android color guidelines', 'color tools', 'web design', 'color picker'],
  openGraph: {
    title: 'Android Color Guidelines | exdreamcolors',
    description: 'Comprehensive guide to android color guidelines. Learn with practical examples.',
    type: 'article',
  },
};

export default function AndroidcolorguidelinesPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-4">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-700">Android Color Guidelines</span>
      </nav>
      
      {/* 文章标题 */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Android Color Guidelines</h1>
      ...
      <article className="prose prose-lg max-w-none">
        <h2>What is Android Color Guidelines?</h2>
        <p>
          Android Color Guidelines is a fundamental concept in color theory and web design that every designer and developer should understand. 
        ...
        <p>
          ...
          mastering android color guidelines will help you make better visual decisions.
        </p>
        
        <h2>Why Android Color Guidelines Matters</h2>
        <p>Understanding android color guidelines is essential because:</p>
        <ul>
        ...
        <h3>1. The Basics</h3>
        <p>
          At its core, android color guidelines involves understanding how colors interact with each other and how they 
...
.button {
  ...
  border-radius: 0.5rem;
        ...
        <p>Use these free tools to implement android color guidelines in your projects:</p>
        ...
        <h2>Conclusion</h2>
        <p>
          Android Color Guidelines is a powerful tool in your design toolkit. By understanding and applying these principles, 
      ...
      {/* 相关文章 */}
      <RelatedArticles currentSlug="android-color-guidelines" />
    </div>
  );
}