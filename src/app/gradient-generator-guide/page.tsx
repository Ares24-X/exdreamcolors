export const metadata = {
  title: 'Gradient Generator Guide - Complete Guide | exdreamcolors',
  description: 'Learn how to use Gradient Generator Guide effectively. Step-by-step tutorial with examples.',
};

export default function GradientgeneratorguidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold mb-6">Gradient Generator Guide</h1>
      
      <div className="prose prose-lg max-w-none">
        <h2>Introduction</h2>
        <p>Welcome to the complete guide for Gradient Generator Guide.</p>
