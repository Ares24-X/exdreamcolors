...
export const metadata = {
  title: 'Earth Tone Color Palette | exdreamcolors',
  description: 'Learn about earth tone color palette. Complete guide with examples, best practices, and practical tips for web designers and developers.',
  keywords: ['earth tone color palette', 'color tools', 'web design', 'color picker'],
  openGraph: {
    title: 'Earth Tone Color Palette | exdreamcolors',
    description: 'Comprehensive guide to earth tone color palette. Learn with practical examples.',
    type: 'article',
  },
};

export default function EarthtonecolorpalettePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-4">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-700">Earth Tone Color Palette</span>
      </nav>
      
      {/* 文章标题 */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Earth Tone Color Palette</h1>
      ...
      <article className="prose prose-lg max-w-none">
        <h2>What is Earth Tone Color Palette?</h2>
        <p>
          Earth Tone Color Palette is a fundamental concept in color theory and web design that every designer and developer should understand. 
        ...
        <p>
          ...
          mastering earth tone color palette will help you make better visual decisions.
        </p>
        
        <h2>Why Earth Tone Color Palette Matters</h2>
        <p>Understanding earth tone color palette is essential because:</p>
        <ul>
        ...
        <h3>1. The Basics</h3>
        <p>
          At its core, earth tone color palette involves understanding how colors interact with each other and how they 
...
.button {
  ...
  border-radius: 0.5rem;
        ...
        <p>Use these free tools to implement earth tone color palette in your projects:</p>
        ...
        <h2>Conclusion</h2>
        <p>
          Earth Tone Color Palette is a powerful tool in your design toolkit. By understanding and applying these principles, 
      ...
      {/* 相关文章 */}
      <RelatedArticles currentSlug="earth-tone-color-palette" />
    </div>
  );
}