...
export const metadata = {
  title: 'Color Schemes for Websites | exdreamcolors',
  description: 'Learn about color schemes for websites. Complete guide with examples, best practices, and practical tips for web designers and developers.',
  keywords: ['color schemes for websites', 'color tools', 'web design', 'color picker'],
  openGraph: {
    title: 'Color Schemes for Websites | exdreamcolors',
    description: 'Comprehensive guide to color schemes for websites. Learn with practical examples.',
    type: 'article',
  },
};

export default function ColorschemesforwebsitesPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-4">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-700">Color Schemes for Websites</span>
      </nav>
      
      {/* 文章标题 */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Color Schemes for Websites</h1>
      ...
      <article className="prose prose-lg max-w-none">
        <h2>What is Color Schemes for Websites?</h2>
        <p>
          Color Schemes for Websites is a fundamental concept in color theory and web design that every designer and developer should understand. 
        ...
        <p>
          ...
          mastering color schemes for websites will help you make better visual decisions.
        </p>
        
        <h2>Why Color Schemes for Websites Matters</h2>
        <p>Understanding color schemes for websites is essential because:</p>
        <ul>
        ...
        <h3>1. The Basics</h3>
        <p>
          At its core, color schemes for websites involves understanding how colors interact with each other and how they 
...
.button {
  ...
  border-radius: 0.5rem;
        ...
        <p>Use these free tools to implement color schemes for websites in your projects:</p>
        ...
        <h2>Conclusion</h2>
        <p>
          Color Schemes for Websites is a powerful tool in your design toolkit. By understanding and applying these principles, 
      ...
      {/* 相关文章 */}
      <RelatedArticles currentSlug="color-schemes-for-websites" />
    </div>
  );
}