...
export const metadata = {
  title: 'Analogous Colors | exdreamcolors',
  description: 'Learn about analogous colors. Complete guide with examples, best practices, and practical tips for web designers and developers.',
  keywords: ['analogous colors', 'color tools', 'web design', 'color picker'],
  openGraph: {
    title: 'Analogous Colors | exdreamcolors',
    description: 'Comprehensive guide to analogous colors. Learn with practical examples.',
    type: 'article',
  },
};

export default function AnalogouscolorsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-4">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-700">Analogous Colors</span>
      </nav>
      
      {/* 文章标题 */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Analogous Colors</h1>
      ...
      <article className="prose prose-lg max-w-none">
        <h2>What is Analogous Colors?</h2>
        <p>
          Analogous Colors is a fundamental concept in color theory and web design that every designer and developer should understand. 
        ...
        <p>
          ...
          mastering analogous colors will help you make better visual decisions.
        </p>
        
        <h2>Why Analogous Colors Matters</h2>
        <p>Understanding analogous colors is essential because:</p>
        <ul>
        ...
        <h3>1. The Basics</h3>
        <p>
          At its core, analogous colors involves understanding how colors interact with each other and how they 
...
.button {
  ...
  border-radius: 0.5rem;
        ...
        <p>Use these free tools to implement analogous colors in your projects:</p>
        ...
        <h2>Conclusion</h2>
        <p>
          Analogous Colors is a powerful tool in your design toolkit. By understanding and applying these principles, 
      ...
      {/* 相关文章 */}
      <RelatedArticles currentSlug="analogous-colors" />
    </div>
  );
}