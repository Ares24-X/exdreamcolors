...
export const metadata = {
  title: 'iOS App Color Guidelines | exdreamcolors',
  description: 'Learn about ios app color guidelines. Complete guide with examples, best practices, and practical tips for web designers and developers.',
  keywords: ['ios app color guidelines', 'color tools', 'web design', 'color picker'],
  openGraph: {
    title: 'iOS App Color Guidelines | exdreamcolors',
    description: 'Comprehensive guide to ios app color guidelines. Learn with practical examples.',
    type: 'article',
  },
};

export default function IosappcolorguidelinesPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-4">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-700">iOS App Color Guidelines</span>
      </nav>
      
      {/* 文章标题 */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-4">iOS App Color Guidelines</h1>
      ...
      <article className="prose prose-lg max-w-none">
        <h2>What is iOS App Color Guidelines?</h2>
        <p>
          iOS App Color Guidelines is a fundamental concept in color theory and web design that every designer and developer should understand. 
        ...
        <p>
          ...
          mastering ios app color guidelines will help you make better visual decisions.
        </p>
        
        <h2>Why iOS App Color Guidelines Matters</h2>
        <p>Understanding ios app color guidelines is essential because:</p>
        <ul>
        ...
        <h3>1. The Basics</h3>
        <p>
          At its core, ios app color guidelines involves understanding how colors interact with each other and how they 
...
.button {
  ...
  border-radius: 0.5rem;
        ...
        <p>Use these free tools to implement ios app color guidelines in your projects:</p>
        ...
        <h2>Conclusion</h2>
        <p>
          iOS App Color Guidelines is a powerful tool in your design toolkit. By understanding and applying these principles, 
      ...
      {/* 相关文章 */}
      <RelatedArticles currentSlug="ios-app-color-guidelines" />
    </div>
  );
}