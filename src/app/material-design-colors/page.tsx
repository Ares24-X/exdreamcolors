...
export const metadata = {
  title: 'Material Design Colors | exdreamcolors',
  description: 'Learn about material design colors. Complete guide with examples, best practices, and practical tips for web designers and developers.',
  keywords: ['material design colors', 'color tools', 'web design', 'color picker'],
  openGraph: {
    title: 'Material Design Colors | exdreamcolors',
    description: 'Comprehensive guide to material design colors. Learn with practical examples.',
    type: 'article',
  },
};

export default function MaterialdesigncolorsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-4">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-700">Material Design Colors</span>
      </nav>
      
      {/* 文章标题 */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Material Design Colors</h1>
      ...
      <article className="prose prose-lg max-w-none">
        <h2>What is Material Design Colors?</h2>
        <p>
          Material Design Colors is a fundamental concept in color theory and web design that every designer and developer should understand. 
        ...
        <p>
          ...
          mastering material design colors will help you make better visual decisions.
        </p>
        
        <h2>Why Material Design Colors Matters</h2>
        <p>Understanding material design colors is essential because:</p>
        <ul>
        ...
        <h3>1. The Basics</h3>
        <p>
          At its core, material design colors involves understanding how colors interact with each other and how they 
...
.button {
  ...
  border-radius: 0.5rem;
        ...
        <p>Use these free tools to implement material design colors in your projects:</p>
        ...
        <h2>Conclusion</h2>
        <p>
          Material Design Colors is a powerful tool in your design toolkit. By understanding and applying these principles, 
      ...
      {/* 相关文章 */}
      <RelatedArticles currentSlug="material-design-colors" />
    </div>
  );
}