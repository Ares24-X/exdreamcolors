...
export const metadata = {
  title: 'Split Complementary Colors | exdreamcolors',
  description: 'Learn about split complementary colors. Complete guide with examples, best practices, and practical tips for web designers and developers.',
  keywords: ['split complementary colors', 'color tools', 'web design', 'color picker'],
  openGraph: {
    title: 'Split Complementary Colors | exdreamcolors',
    description: 'Comprehensive guide to split complementary colors. Learn with practical examples.',
    type: 'article',
  },
};

export default function SplitcomplementarycolorsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-4">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-700">Split Complementary Colors</span>
      </nav>
      
      {/* 文章标题 */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Split Complementary Colors</h1>
        <div className="flex items-center gap-4 text-sm text-gray-500">
          <span>5 min read</span>
          <span>|</span>
          <span>Updated 2026-05-30</span>
        </div>
      </header>
      
      {/* 文章内容 */}
      <article className="prose prose-lg max-w-none">
        <h2>What is Split Complementary Colors?</h2>
        <p>
          Split Complementary Colors is a fundamental concept in color theory and web design that every designer and developer should understand. 
        ...
        <p>
          ...
          mastering split complementary colors will help you make better visual decisions.
        </p>
        
        <h2>Why Split Complementary Colors Matters</h2>
        <p>Understanding split complementary colors is essential because:</p>
        <ul>
        ...
        <h3>1. The Basics</h3>
        <p>
          At its core, split complementary colors involves understanding how colors interact with each other and how they 
...
{'}'}
        ...
        <p>Use these free tools to implement split complementary colors in your projects:</p>
        ...
        <h2>Conclusion</h2>
        <p>
          Split Complementary Colors is a powerful tool in your design toolkit. By understanding and applying these principles, 
      ...
      {/* 相关文章 */}
      <RelatedArticles currentSlug="split-complementary-colors" />
    </div>
  );
}