...
export const metadata = {
  title: 'Complementary Colors | exdreamcolors',
  description: 'Learn about complementary colors. Complete guide with examples, best practices, and practical tips for web designers and developers.',
  keywords: ['complementary colors', 'color tools', 'web design', 'color picker'],
  openGraph: {
    title: 'Complementary Colors | exdreamcolors',
    description: 'Comprehensive guide to complementary colors. Learn with practical examples.',
    type: 'article',
  },
};

export default function ComplementarycolorsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-4">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-700">Complementary Colors</span>
      </nav>
      
      {/* 文章标题 */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Complementary Colors</h1>
      ...
      <article className="prose prose-lg max-w-none">
        <h2>What is Complementary Colors?</h2>
        <p>
          Complementary Colors is a fundamental concept in color theory and web design that every designer and developer should understand. 
        ...
        <p>
          ...
          mastering complementary colors will help you make better visual decisions.
        </p>
        
        <h2>Why Complementary Colors Matters</h2>
        <p>Understanding complementary colors is essential because:</p>
        <ul>
        ...
        <h3>1. The Basics</h3>
        <p>
          At its core, complementary colors involves understanding how colors interact with each other and how they 
...
.button {
  ...
  border-radius: 0.5rem;
        ...
        <p>Use these free tools to implement complementary colors in your projects:</p>
        ...
        <h2>Conclusion</h2>
        <p>
          Complementary Colors is a powerful tool in your design toolkit. By understanding and applying these principles, 
      ...
      {/* 相关文章 */}
      <RelatedArticles currentSlug="complementary-colors" />
    </div>
  );
}