...
export const metadata = {
  title: 'What is HEX Color Code | exdreamcolors',
  description: 'Learn about what is hex color code. Complete guide with examples, best practices, and practical tips for web designers and developers.',
  keywords: ['what is hex color code', 'color tools', 'web design', 'color picker'],
  openGraph: {
    title: 'What is HEX Color Code | exdreamcolors',
    description: 'Comprehensive guide to what is hex color code. Learn with practical examples.',
    type: 'article',
  },
};

export default function WhatishexcolorPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-4">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-700">What is HEX Color Code</span>
      </nav>
      
      {/* 文章标题 */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-4">What is HEX Color Code</h1>
        <div className="flex items-center gap-4 text-sm text-gray-500">
          <span>5 min read</span>
          <span>|</span>
          <span>Updated 2026-05-28</span>
        </div>
      </header>
      
      {/* 文章内容 */}
      <article className="prose prose-lg max-w-none">
        <h2>What is What is HEX Color Code?</h2>
        <p>
          What is HEX Color Code is a fundamental concept in color theory and web design that every designer and developer should understand. 
        ...
        <p>
          ...
          mastering what is hex color code will help you make better visual decisions.
        </p>
        
        <h2>Why What is HEX Color Code Matters</h2>
        <p>Understanding what is hex color code is essential because:</p>
        <ul>
        ...
        <h3>1. The Basics</h3>
        <p>
          At its core, what is hex color code involves understanding how colors interact with each other and how they 
...
{'}'}
        ...
        <p>Use these free tools to implement what is hex color code in your projects:</p>
        ...
        <h2>Conclusion</h2>
        <p>
          What is HEX Color Code is a powerful tool in your design toolkit. By understanding and applying these principles, 
      ...
      {/* 相关文章 */}
      <RelatedArticles currentSlug="what-is-hex-color" />
    </div>
  );
}