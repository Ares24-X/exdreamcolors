...
export const metadata = {
  title: 'Color Blind Friendly Palettes | exdreamcolors',
  description: 'Learn about color blind friendly palettes. Complete guide with examples, best practices, and practical tips for web designers and developers.',
  keywords: ['color blind friendly palettes', 'color tools', 'web design', 'color picker'],
  openGraph: {
    title: 'Color Blind Friendly Palettes | exdreamcolors',
    description: 'Comprehensive guide to color blind friendly palettes. Learn with practical examples.',
    type: 'article',
  },
};

export default function ColorblindfriendlypalettesPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-4">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-700">Color Blind Friendly Palettes</span>
      </nav>
      
      {/* 文章标题 */}
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Color Blind Friendly Palettes</h1>
      ...
      <article className="prose prose-lg max-w-none">
        <h2>What is Color Blind Friendly Palettes?</h2>
        <p>
          Color Blind Friendly Palettes is a fundamental concept in color theory and web design that every designer and developer should understand. 
        ...
        <p>
          ...
          mastering color blind friendly palettes will help you make better visual decisions.
        </p>
        
        <h2>Why Color Blind Friendly Palettes Matters</h2>
        <p>Understanding color blind friendly palettes is essential because:</p>
        <ul>
        ...
        <h3>1. The Basics</h3>
        <p>
          At its core, color blind friendly palettes involves understanding how colors interact with each other and how they 
...
.button {
  ...
  border-radius: 0.5rem;
        ...
        <p>Use these free tools to implement color blind friendly palettes in your projects:</p>
        ...
        <h2>Conclusion</h2>
        <p>
          Color Blind Friendly Palettes is a powerful tool in your design toolkit. By understanding and applying these principles, 
      ...
      {/* 相关文章 */}
      <RelatedArticles currentSlug="color-blind-friendly-palettes" />
    </div>
  );
}