...
export const articleDatabase: Record<string, ArticleMeta> = {
  ...
  "wcag-color-accessibility": { slug: "wcag-color-accessibility", title: "WCAG Accessibility", description: "Understand WCAG 2.2 color requirements: AA/AAA contrast ratios, non-text contrast rules, focus indicator specs, and how to audit your site against each success criterion." },
