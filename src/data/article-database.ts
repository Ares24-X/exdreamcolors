...
export const articleDatabase: Record<string, ArticleMeta> = {
  ...
  "color-accessibility-guidelines": { slug: "color-accessibility-guidelines", title: "Color Accessibility Guidelines", description: "96.8% of top websites fail WCAG color contrast. This guide covers the exact ratios, legal requirements, testing methods, and fix patterns for text, buttons, and UI components." },
  ...
  "color-blind-friendly-palettes": { slug: "color-blind-friendly-palettes", title: "Color Blind Friendly Palettes", description: "300 million people are color blind. Build palettes that pass deuteranopia, protanopia, and tritanopia simulation with safe hue pairs, pattern overlays, and redundant signals." },
  ...
  "color-psychology-healthcare": { slug: "color-psychology-healthcare", title: "Color Psychology in Healthcare", description: "How healthcare brands use color to build trust, reduce anxiety, and communicate care." },
  ...
  "dark-mode-colors": { slug: "dark-mode-colors", title: "Dark Mode Colors: Surface, Border, and Text Ratios That Actually Pass", description: "The standard dark elevation stack measures 1.08:1 between surfaces where WCAG needs 3:1. Measured border, focus ring, and text tokens for every dark surface, plus the CI check scanners skip." },
  ...
  "micro-interactions-color-feedback": { slug: "micro-interactions-color-feedback", title: "Micro-interactions and Color Feedback", description: "Use color shifts in buttons, forms, loading states, and confirmations to make interfaces feel faster, clearer, and easier to trust." },
  ...
  "wcag-color-accessibility": { slug: "wcag-color-accessibility", title: "WCAG Color Accessibility: All 7 Success Criteria Explained", description: "80-site audit shows 84% fail the newest WCAG 2.2 focus criterion and 76% fail non-text contrast. Map all 7 color-related success criteria with measured thresholds, automated vs manual detection gaps, and a per-criterion audit checklist." },
  "wcag-contrast-checker-tool": { slug: "wcag-contrast-checker-tool", title: "WCAG Contrast Checker Tool", description: "Compare WCAG contrast checker tools: browser extensions, CLI scripts, Figma plugins, and automated CI checks that catch contrast failures before they ship." },
  "wcag-contrast-checker-for-dark-mode": { slug: "wcag-contrast-checker-for-dark-mode", title: "WCAG Contrast Checker for Dark Mode", description: "73% of dark modes fail WCAG contrast on muted text. Get tested token pairs, a 30-site audit breakdown, elevation hierarchy patterns, and a 10-point pre-ship checklist for dark UI contrast." },
  "wcag-contrast-checker-for-buttons": { slug: "wcag-contrast-checker-for-buttons", title: "WCAG Contrast Checker for Buttons", description: "72% of component libraries fail WCAG on at least one button state. Exact fix tokens for Ant Design, Bootstrap, and Chakra, plus a 5-state audit matrix with measured ratios." },
  ...
  "accessible-data-visualization": { slug: "accessible-data-visualization", title: "Accessible Data Visualization", description: "Design charts, graphs, and dashboards that communicate clearly to people with color vision deficiency — patterns, labels, and contrast strategies that actually work." },
  ...
  "oklch-color-design-guide": { slug: "oklch-color-design-guide", title: "OKLCH Color Design Guide", description: "Build perceptually uniform color scales, accessible dark mode variants, and CSS token systems with OKLCH. Fallback-safe implementation, chart palette generation, and WCAG contrast validation." },
  ...
  "form-validation-color-accessibility": { slug: "form-validation-color-accessibility", title: "Form Validation Color Accessibility Guide", description: "62% of checkout forms fail WCAG 1.4.1 by relying on red borders alone. Contrast-safe error tokens, ARIA patterns, and a 10-point pre-ship checklist." },
